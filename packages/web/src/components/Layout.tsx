        ...
        >
          ...
          <nav className="flex-1 py-3 overflow-y-auto">
            <div className="px-3 space-y-0.5">
              ...
              <GameNavLink to="/plugins" icon={<ExtensionsIcon />} label="Extensions" />
              <GameNavLink to="/skills" icon={<SkillsIcon />} label="Skills" />
            </div>
              ...
              <>
                ...
                {agents.map((agent) => (
                  <div key={agent.id} className="px-3">
                    ...
                    >
                      <div
                        className="w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center text-[9px] font-bold text-white relative"
          ...
          <div className="px-3 py-3 space-y-0.5" style={{ borderTop: '1px solid rgba(255,255,255,0.10)' }}>
            {currentUser?.is_admin && <GameNavLink to="/roles" icon={<TagIcon />} label="Roles" />}
