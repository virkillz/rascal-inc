...
export default function SettingsRoles() {
  ...
  return (
    <div className="flex h-full">
      {/* Role list */}
      <div className="w-48 flex-shrink-0 flex flex-col" style={{ borderRight: '1px solid var(--border)' }}>
        <div className="px-4 py-3 flex items-center justify-between" style={{ borderBottom: '1px solid var(--border)' }}>
          <span className="text-xs font-semibold uppercase tracking-wide" style={{ color: 'var(--muted)' }}>Roles</span>
          <button
            onClick={startCreate}
        ...
        <div className="flex-1 overflow-y-auto py-2">
          ...
          {roles.length === 0 && (
            <p className="px-4 py-3 text-xs" style={{ color: 'var(--muted)' }}>No roles yet.</p>
          )}
        </div>
      </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-sm" style={{ color: 'var(--muted)' }}>{selected?.description || '—'}</p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <pre
                    className="text-sm whitespace-pre-wrap border border-border rounded-lg p-3 font-mono"
